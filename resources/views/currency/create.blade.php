...
@section('content')
    ...
    <h1 class="display-1 mt-5 text-white">Создание валюты</h1>

    <form class="my-5" action="{{ route('currency.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="remainder" class="form-label text-white">Количество валюты</label>
